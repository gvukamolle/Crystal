...
Cristal — это плагин для Obsidian, который интегрирует Claude Code CLI прямо в ваше хранилище заметок:
...
Создавайте свои навыки в `.cristal/skills/<skill-name>/SKILL.md`
